        ...
        <section>
            ...
            <CardWrapper>
                ...
                <HeadingsRight>
                    ...
                    <P>
                        With roots in Finance & Real Estate, I discovered the joy of solving real
                        business problems with code.
                    </P>

                    <P>
                        Since then, I have been voraciously studying JavaScript, computer science,
                        and modern tools in the web development space.
                    </P>

                    <P>
                        Overall, I'm about serving others, software performance, long-term
                        scalability, team success, balancing stakeholder ambitions with business
                        goals, & writing code with a smile on my face :)
                    </P>
                </HeadingsRight>
            </CardWrapper>
        </section>
