	...
	overrideStyles: ({ rhythm, scale }, options) => {
		return {
			...
			'.post a:not(.gatsby-resp-image-link):not(.anchor), .link-underline': {
				...
				textShadow: `0.03em 0 ${colors.white}, -0.03em 0 ${colors.white}, 0 0.03em ${colors.white}, 0 -0.03em ${
					colors.white
				}, 0.06em 0 ${colors.white}, -0.06em 0 ${colors.white}, 0.09em 0 ${colors.white}, -0.09em 0 ${
					colors.white
				}, 0.12em 0 ${colors.white}, -0.12em 0 ${colors.white}, 0.15em 0 ${colors.white}, -0.15em 0 ${colors.white}`,
