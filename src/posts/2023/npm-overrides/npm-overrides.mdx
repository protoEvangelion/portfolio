...
Using npm v8+, add something like this to your package.json to override peer dependencies:
...
> The $ sign will point to the version listed in your package json dynamically. So if you have react v17 in your package.json `$react` will point to v17.
