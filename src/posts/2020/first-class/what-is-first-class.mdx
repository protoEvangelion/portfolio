...
*What does it mean for a thing in a programming language to be first class?* **It means it is a value**. Why is this important? One reason is that you cannot compose operators in non functional first languages.
